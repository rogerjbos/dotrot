...
library Templates {
    ...
    function svgHeader() internal pure returns (string memory) {
        return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" width="1000" height="1000" role="img" aria-label="Giggles and Gags">';
    }
    ...
    function textStyleTemplate(uint8 variant, bool rareMode) internal pure returns (string memory) {
        ...
        string memory styles1 = string.concat(
            ...
            ".main-text{fill:",
            fill,
            ";font-family:monospace;font-weight:",
            fontWeight,
            ";letter-spacing:",
            letterSpacing,
            ";}"
        ...
        return string.concat(
            ...
            ".outline-text{paint-order:stroke;stroke:",
            stroke,
    ...
    function logoTemplate(bool rareMode) internal pure returns (string memory) {
        ...
        return string.concat(
            ...
            '<circle cx="0" cy="0" r="18" fill="none" stroke="',
            accent,
            '" stroke-width="4"/>',
            '<circle cx="42" cy="0" r="18" fill="none" stroke="',
            accent,
            '" stroke-width="4"/>',
            '<text x="84" y="8" fill="',
            fill,
            '" font-family="monospace" font-size="30" font-weight="900">GaG</text>',
            "</g>"
        );
    }
    ...
    function badgeTemplate(string memory label, bool rareMode) internal pure returns (string memory) {
        ...
        return string.concat(
            ...
            '<rect x="0" y="0" width="170" height="44" rx="22" fill="',
            fill,
            '"/>',
     ...
     */
    function buildSingleLineTextNode(string memory escapedText, uint256 fontSize, uint8 variant)
        internal
        pure
        returns (string memory)
    {
        ...
        return string.concat(
            '<text x="500" y="',
            y,
            '" text-anchor="middle" dominant-baseline="middle" class="main-text outline-text" font-size="',
            _toString(fontSize),
            '">',
            escapedText,
            "</text>"
     ...
     */
    function buildTwoLineTextNode(string memory escapedLine1, string memory escapedLine2, uint256 fontSize)
        internal
        pure
        returns (string memory)
    {
    ...
    function captionLine(string memory caption) internal pure returns (string memory) {
        return string.concat('<text x="500" y="875" text-anchor="middle" class="caption-text">', caption, "</text>");
    }
    ...
    function tokenIdLabel(uint256 tokenId) internal pure returns (string memory) {
        return
            string.concat(
                '<text x="76" y="982" text-anchor="start" class="footer-text">#', _toString(tokenId), "</text>"
            );
    }
    ...
    function _terminalGrid(bool rareMode) private pure returns (string memory) {
        ...
        return string.concat(
            ...
            '<rect x="40" y="40" width="920" height="920" fill="',
            secondaryFill,
            '"/>',
            '<g opacity="0.16" stroke="',
            accent,
     ...
     */
    function _wavePath(uint256 y0, uint256 c1y, uint256 c2y, uint256 midY, uint256 s1y, uint256 endY)
        private
        pure
        returns (string memory)
    {
    ...
    function _softCopingFrame(bool rareMode) private pure returns (string memory) {
        ...
        return string.concat(
            ...
            '<rect x="74" y="74" width="852" height="836" rx="28" stroke="',
            accent,
    ...
    function _doubleDownFrame(bool rareMode) private pure returns (string memory) {
        ...
        return string.concat(
            ...
            '<rect x="82" y="82" width="836" height="828" rx="12" stroke="',
            accent,
            '" stroke-width="4" fill="none" opacity="0.72"/>'
        );
    }
    ...
    function _badgeOfShameFrame(bool rareMode) private pure returns (string memory) {
        ...
        return string.concat(
            ...
            '<path d="M180 74H820" stroke="',
            accent,
            '" stroke-width="8" opacity="0.8"/>',
            '<path d="M180 908H820" stroke="',
            accent,
            '" stroke-width="8" opacity="0.8"/>'
        );
    }
    ...
    function _dot(bytes32 seed, uint256 i) private pure returns (string memory) {
        ...
        return string.concat('<circle cx="', _toString(x), '" cy="', _toString(y), '" r="', _toString(r), '"/>');
    }
